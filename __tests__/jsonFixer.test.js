...
test("should successfully transform bad json no quotes in key to parseable json", () => {
  const badJson = `{ single: '2' }`;
  const goodJson = fixJson(badJson);
...
test("should successfully transform bad json string and numbers to parseable json", () => {
...
test("should successfully transform bad json object to parseable json", () => {
...
test("should successfully transform bad json array to parseable json", () => {
...
test("should fail when real bad format", () => {
